...
namespace addon\zzhc\app\listener\diy;
...
class ThemeColorListener
{
    ...
    {
        if (!empty($params[ 'key' ]) && $params[ 'key' ] == 'zzhc') {
            return [
                // 系统主题色
                'theme_color' => [
                    [
                ...
                'theme_field' => [
                    ...
                    [
                        ...
                        'value' => "#e1251b",
                        'tip' => "禁用色在uniapp中使用：var(--price-text-color)",
                    ],
                ]
            ];
        }
